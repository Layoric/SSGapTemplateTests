...
module.exports = function (grunt) {
    ...
    var resourcesRoot = '../ReactDesktopApps1.Resources/';
    var webRoot = 'wwwroot/';
    ...
    grunt.initConfig({
        ...
        msbuild: {
            'release-console': {
                src: ['../ReactDesktopApps1.AppConsole/ReactDesktopApps1.AppConsole.csproj'],
                options: {
            ...
            'release-winforms': {
                src: ['../ReactDesktopApps1.AppWinForms/ReactDesktopApps1.AppWinForms.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
            ...
            'release-resources': {
                src: ['..\\ReactDesktopApps1.Resources\\ReactDesktopApps1.Resources.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
        ...
        nugetrestore: {
            'restore-console': {
                src: '../ReactDesktopApps1.AppConsole/packages.config',
                dest: '../../packages/'
            },
            'restore-winforms': {
                src: '../ReactDesktopApps1.AppWinForms/packages.config',
                dest: '../../packages/'
            },
            'restore-webapp': {
                src: './packages.config',
            ...
            'restore-resources': {
                src: '../ReactDesktopApps1.Resources/packages.config',
                dest: '../../packages/'
            }
        },
        msdeploy: {
        ...
        gulp: {
            ...
            'wwwroot-bundle': function () {
                ...
                return gulp.src(['./**/*.html', '!wwwroot_build/**/*', '!wwwroot/**/*', '!bower_components/**/*', '!node_modules/**/*'])
                    ...
                    .pipe(assets.restore())
                    .pipe(useref())
                    .pipe(gulpif('*.html', header("<!-- Auto generated file on " + (new Date().toLocaleTimeString()) + " by ReactDesktopApps1\\gruntfile.js -->\r\n")))
