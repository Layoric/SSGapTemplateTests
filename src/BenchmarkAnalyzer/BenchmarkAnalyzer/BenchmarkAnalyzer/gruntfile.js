...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        msbuild: {
            'release-console': {
                src: ['../BenchmarkAnalyzer.AppConsole/BenchmarkAnalyzer.AppConsole.csproj'],
                options: {
            ...
            'release-winforms': {
                src: ['../BenchmarkAnalyzer.AppWinForms/BenchmarkAnalyzer.AppWinForms.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
        ...
        nugetrestore: {
            'restore-console': {
                src: '../BenchmarkAnalyzer.AppConsole/packages.config',
                dest: '../../packages/'
            },
            'restore-winforms': {
                src: '../BenchmarkAnalyzer.AppWinForms/packages.config',
                dest: '../../packages/'
            }
        },
        gulp: {
