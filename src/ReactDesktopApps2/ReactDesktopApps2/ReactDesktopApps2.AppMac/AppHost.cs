...
using ReactDesktopApps2.ServiceInterface;
using ReactDesktopApps2.Resources;

namespace ReactDesktopApps2.AppMac
{
	public class AppHost : AppSelfHostBase
	{
		...
		/// </summary>
		public AppHost()
			: base("ReactDesktopApps2.AppMac", typeof(MyServices).Assembly) {}
		...
		public void ShowAbout()
		{
			...
			MainClass.MainMenu.InvokeOnMainThread (() => {
				foreach (var item in MainClass.MainMenu.ItemArray()) {
					if (item.Title == "ReactDesktopApps2") {
