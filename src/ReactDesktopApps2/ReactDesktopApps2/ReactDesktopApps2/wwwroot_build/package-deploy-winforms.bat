...
SET TOOLS=.\tools
SET STAGINGZIP=ReactDesktopApps2-winforms.7z
SET OUTPUTNAME=ReactDesktopApps2-winforms.exe
SET RELEASE=..\..\ReactDesktopApps2.AppWinForms\bin\x86\Release
COPY %RELEASE%\ReactDesktopApps2.AppWinForms.exe .\%STAGING%
COPY %RELEASE%\ReactDesktopApps2.AppWinForms.exe.config .\%STAGING%
