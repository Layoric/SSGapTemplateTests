...
module.exports = function (grunt) {
    ...
    var resourcesRoot = '../ReactDesktopApps2.Resources/';
    var webRoot = 'wwwroot/';
    ...
    grunt.initConfig({
        ...
        msbuild: {
            'release-console': {
                src: ['../ReactDesktopApps2.AppConsole/ReactDesktopApps2.AppConsole.csproj'],
                options: {
            ...
            'release-winforms': {
                src: ['../ReactDesktopApps2.AppWinForms/ReactDesktopApps2.AppWinForms.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
            ...
            'release-resources': {
                src: ['..\\ReactDesktopApps2.Resources\\ReactDesktopApps2.Resources.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
        ...
        nugetrestore: {
            'restore-console': {
                src: '../ReactDesktopApps2.AppConsole/packages.config',
                dest: '../../packages/'
            },
            'restore-winforms': {
                src: '../ReactDesktopApps2.AppWinForms/packages.config',
                dest: '../../packages/'
            },
            'restore-webapp': {
                src: './packages.config',
            ...
            'restore-resources': {
                src: '../ReactDesktopApps2.Resources/packages.config',
                dest: '../../packages/'
            }
        },
        msdeploy: {
        ...
        gulp: {
            ...
            'wwwroot-bundle': function () {
                ...
                return gulp.src(['./**/*.html', '!wwwroot_build/**/*', '!wwwroot/**/*', '!bower_components/**/*', '!node_modules/**/*'])
                    ...
                    .pipe(assets.restore())
                    .pipe(useref())
                    .pipe(gulpif('*.html', header("<!-- Auto generated file on " + (new Date().toLocaleTimeString()) + " by ReactDesktopApps2\\gruntfile.js -->\r\n")))
                    .pipe(gulp.dest(resourcesRoot))
                    .pipe(gulp.dest(webRoot));

            },
            'copy-resources-lib': function () {
                return gulp.src('../ReactDesktopApps2.Resources/bin/Release/ReactDesktopApps2.Resources.dll')
